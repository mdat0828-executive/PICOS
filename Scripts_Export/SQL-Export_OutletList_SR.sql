                                                        /* ============================ TRADITIONAL TRADE COVERAGE OUTLET LIST -- SR -- ============================*/
...
WHERE 1 = 1 and OutletID not in (66206121)/*Loại khỏi pool outlet khảo sát cho tháng 06 & 07 theo aproval từ Thế Anh trên group Sale Ops ngày 25/05/2026*/
